// Star Gap content script — injecté sur www.semrush.com/*
...
(function () {
  ...
  function isOrganicResearchPage() {
    return /^\/analytics\/organic\/positions/.test(window.location.pathname);
  }
  ...
  function captureTokenFromUrl() {
    try {
      ...
      // Semrush utilise q= pour le domaine cible.
      ...
      console.error('[Star Gap] Erreur lecture token URL Semrush', e);
    }
  }
      ...
      return `
        ...
        <div class="sg-banner-text">
          ...
          <div class="sg-banner-message">
            Clique sur <strong>Export</strong> au-dessus de la table (icône
            de téléchargement). Choisis le format CSV — Star Gap récupère
