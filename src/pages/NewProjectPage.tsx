...
export function NewProjectPage() {
  ...
  return (
    <div className="page-ambient min-h-full">
      ...
      <section className="glass-card glass-edge relative z-40 rounded-2xl p-6">
      ...
      <section
        className="glass-card glass-edge relative z-20 mt-6 rounded-2xl p-6"
      ...
      <section className="glass-card glass-edge relative z-10 mt-6 rounded-2xl p-6">
